...
# Class: is_analytics_dashboard570
# Init class of Identity Server Analytics - Dashboard profile
class is_analytics_dashboard570 inherits is_analytics_dashboard570::params {
  ...
  /*
    ...
    Note: Ensure that file is available in modules -> is_analytics_dashboard570 -> files
  */
