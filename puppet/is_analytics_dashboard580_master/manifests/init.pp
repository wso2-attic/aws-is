...
# Class: is_analytics_dashboard580_master
# Init class of Identity Server Analytics - Dashboard profile
class is_analytics_dashboard580_master inherits is_analytics_dashboard580_master::params {
  ...
  /*
    ...
    Note: Ensure that file is available in modules -> is_analytics_dashboard580_master -> files
  */
