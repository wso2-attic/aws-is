...
# Class: is_analytics_dashboard580
# Init class of Identity Server Analytics - Dashboard profile
class is_analytics_dashboard580 inherits is_analytics_dashboard580::params {
  ...
  # Unzip distribution
    ...
    file { "binary":
      ...
      group  => $user_group,
      mode   => '0644',
      source => "puppet:///modules/is_analytics_dashboard580/${product_binary}",
    }
    ...
    /*
      ...
      Note: Ensure that file is available in modules -> is_analytics_dashboard580 -> files
    */
