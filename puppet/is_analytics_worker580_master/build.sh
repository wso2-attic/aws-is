...
export FACTER_profile=is_analytics_worker580_master
puppet agent -vt
...
copy_to_agent() {
  ...
  cp ${product_binary} ${puppet_env}/modules/is_analytics_worker580/files/
}
...
then
  ...
  while read -r line; do
    ...
    template_file=${puppet_env}/modules/is_analytics_worker580_master/templates/carbon-home/${filepath}.erb
    if [[ -f ${template_file} ]]
    then
