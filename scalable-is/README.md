...
4. Browse to the cloned repository and select the [scalable-is](https://github.com/wso2/aws-is/tree/master/scalable-is) template and proceed with the deployment.
